...
This study combines outlines of the original surface extent of LIPs through the Phanerozoic, a paleogeographic model, and LIP erosion models to estimate LIP area in all latitudinal bands through the Phanerozoic. We then compare these LIP area time series to the latitudinal extent of continental ice sheets - a proxy for Earth's long term climate state.
