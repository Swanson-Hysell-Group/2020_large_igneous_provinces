...
\begin{figure}[h!]
\begin{center}
	\includegraphics[width=0.8\textwidth]{Manuscript/Figures/Climatology.pdf}
	\caption{Zonally averaged modern climatological data used to define the tropical rain belt \citep{Kalnay1996a, Trenberth2011a}. Precipitation and evaporation minus precipitation data are from land and ocean, whereas runoff data are from land only. Note that all of these metrics increase/decrease sharply between $\pm$10\textdegree\xspace and $\pm$20\textdegree\xspace.}
